...
namespace ILRepacking.Steps
{
    internal class AttributesRepackStep : IRepackStep
    {
        ...
        public void Perform()
        {
            ...
            {
                AssemblyDefinition attributeAsm = AssemblyDefinition.ReadAssembly(_options.AttributeFile, new ReaderParameters(ReadingMode.Immediate)
                {
#if !NETCOREAPP2_0
					AssemblyResolver = _repackContext.GlobalAssemblyResolver
#endif
                });
