...
namespace ILRepack.Tests
{
    ...
    class RepackOptionsTests
    {
        ...
        public void WithOptionTargetKindInvalid__Parse__TargetKindIsSet()
        {
            ...
            Assert.Throws(typeof(RepackOptions.InvalidTargetKindException), Parse);
        }
        ...
        public void WithNoInputAssemblies__ParseProperties__ThrowException()
        {
	        ...
	        Assert.That(options.Validate,
		        Throws.TypeOf<ArgumentException>().And.Message.Contains("No input files given."));
        }
        ...
        public void WithNoKeyFile__ParseProperties__ThrowException()
        {
            ...
            Parse();
	        Assert.That(options.Validate,
		        Throws.TypeOf<ArgumentException>().And.Message.Contains("KeyFile does not exist"));
        }
